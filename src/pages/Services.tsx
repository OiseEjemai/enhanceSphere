...
function Services() {
  ...
  return (
    <div>
      <header className="absolute inset-x-0 top-0 z-50">
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            ...
            <a href="/services" className="text-sm/6 font-semibold text-gray-900 underline">Services</a>
      ...
      <section className="pt-20 lg:pt-[120px] pb-12 lg:pb-[90px] flex flex-row items-center justify-center">
        <div className="container">
          <div className="flex flex-wrap -mx-4">
            ...
            "
                ...
                <h2>Ready to take the first step toward a better life? Contact us today for a free consultation!</h2>
              </div>
            </div>
          </div>
          <div className="flex flex-wrap -mx-4">
         ...
         p-10
            ...
            hover:shadow-lg
            mb-8
            hover:bg-primary hover:text-gray-500 hover:cursor-pointer
            transition
            transform
            hover:-translate-y-2
         "
            ...
            "
                ...
                <p className="text-body-color">
                  At EnhanceSphere, we believe personal well-being is the foundation of success. Our personal
                  development services are designed to help you achieve greater balance and fulfillment in all
                  areas of life, from relationships to health.
                </p>
                <br />
                <p>
                ...
                <br />
                <p>● Relationship Coaching: Strengthen your personal and professional relationships
                  through improved communication, emotional intelligence, and conflict resolution.
                  <br />
                  <br />
                  ● Social Skills & Networking: Build confidence in social situations and develop effective
                  networking strategies to enhance your career.
                  <br />
                  <br />
                  ● Health & Wellness: Develop a sustainable fitness plan, manage stress, and improve
                  your mental well-being.
                  <br />
                  <br />
                  ● Yoga & Mindfulness: Personalized yoga and mindfulness sessions to cultivate inner
                  peace, focus, and clarity.</p>
              </div>
            </div>
            <div className="w-full md:w-1/2 lg:w-1/3 px-4">
              <div
         ...
         "
            ...
            "
                ...
                <p className="text-body-color">
                  Our financial services help you plan for a secure future and make informed decisions to build
                  wealth over time.
                </p>
                <br />
                <p>
                ...
                <br />
                <p>
                  ● Investment Guidance: Learn how to invest wisely in stocks, mutual funds, real estate,
                  and businesses for long-term gains.
                  <br />
                  <br />
                  ● Systematic Investment Plans (SIPs): Start SIPs to build wealth steadily with expert
                  advice on planning and risk management.
                  <br />
                  <br />
                  ● Real Estate Investments: Explore lucrative real estate opportunities and strategies for
                  long-term wealth.
                  <br />
                  <br />
                  ● Business Investments: Receive expert advice on exploring new business opportunities,
                  funding options, and strategic investments.
                </p>
              </div>
            </div>
            <div className="w-full md:w-1/2 lg:w-1/3 px-4">
         ...
         "
            ...
            "
                ...
                <p className="text-body-color">
                  EnhanceSphere helps you advance your career by providing the resources and strategies to
                  land your dream job or skill up for better opportunities.
                </p>
                <br />
                <p>
                ...
                <br />
                <p>
                  ● Career Coaching: Get expert guidance on job search strategies, resume optimization,
                  interview coaching, and career advancement.
                  <br />
                  <br />
                  ● Skill Development: Learn high-demand skills such as AI, digital marketing, data
                  science, and more to stay competitive in today’s job market.
                  <br />
                  <br />
                  ● Leadership Training: Cultivate leadership and managerial skills to fast-track your career
                  growth and promotions.
                  <br />
                  <br />
                  ● Networking Strategies: Master the art of professional networking to open doors for
         ...
         "
            ...
            "
                ...
                <p className="text-body-color">
                  For business owners, EnhanceSphere provides comprehensive support, not only for personal
                  growth but also for scaling your business and achieving greater success.
                </p>
                <br />
                <p>
                ...
                <br />
                <p>
                  ● Personal Growth for Entrepreneurs: Take advantage of the same personal
                  development services offered to individuals, including health and wellness, social skills,
                  and relationship coaching.
                  <br />
                  <br />
                  ● Business Growth Strategy: Receive customized business strategies, market research,
                  and financial planning to help you scale and grow your business effectively.
                  <br />
                  <br />
                  ● Ongoing Business Mentorship: Get continuous support and performance evaluations
                  to ensure your business stays on track and thrives.
                </p>
              </div>
            </div>
          </div>
